...
public class Anvil {
    ...
    public void moveAndOpen(double power) {

    }

    public void Garbmoveforward(double power) {
        moveForward(1);
    }

    public void movef(double speed, int time) {
        moveForward(speed);
        sleep(time);
        moveForward(0);
    }

    public void hi(double speed, int time) {
        moveForward(speed);
        sleep(time);
        moveForward(0);
    }

    public void square(double move_speed, double turn_speed) {
    ...
    public void speed88888(double movespeed) {
        int move = 0;
        while (move <= 8) {
            move++;
            if (move >= 9) {
    ...
    public boolean getTouch(){
        if (touchSensor.getState()) return false;
         else return true;
    }
}